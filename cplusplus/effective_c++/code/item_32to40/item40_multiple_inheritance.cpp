...
namespace ordinary {
struct Device { explicit Device(int value) : id(value) {} int id; };
struct Scanner : Device { Scanner() : Device(1) {} };
struct Printer : Device { Printer() : Device(2) {} };
...
struct Copier : Scanner, Printer { Copier() : Device(42) {} };
}
struct Readable {
