...
struct EmptyPolicy {};
struct WithMember { EmptyPolicy policy; int value{}; };
struct WithBase : private EmptyPolicy { int value{}; };
#if __cplusplus >= 202002L
struct WithAttribute { [[no_unique_address]] EmptyPolicy policy; int value{}; };
#endif
int main() {
    Monitor monitor;
    monitor.poll();
